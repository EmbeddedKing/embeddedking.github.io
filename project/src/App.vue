            ...
            <div class="hero__slider swiper-container">
                ...
                <div class="swiper-wrapper">
                    <article class="hero__slide swiper-slide">
                        <div class="hero__entry-image" :style="'background-image: url(' + (featured01) + ');'"></div>
                    ...
                    <article class="hero__slide swiper-slide">
                        <div class="hero__entry-image" :style="'background-image: url(' + (featured02) + ');'"></div>
                        <div class="hero__entry-text">
                            <div class="hero__entry-text-inner">
                                <div class="hero__entry-meta">
                                    <span class="cat-links">
                    ...
                    <article class="hero__slide swiper-slide">
                        <div class="hero__entry-image" :style="'background-image: url(' + (featured03) + ');'"></div>
                        <div class="hero__entry-text">
                            <div class="hero__entry-text-inner">
                                <div class="hero__entry-meta">
                                    <span class="cat-links">
...
<script setup>
import featured01 from "/src/images/thumbs/featured/featured-01_2000.jpg"
import featured02 from "/src/images/thumbs/featured/featured-02_2000.jpg"
import featured03 from "/src/images/thumbs/featured/featured-03_2000.jpg"
</script>