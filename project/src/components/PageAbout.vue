                ...
                <div class="row block-lg-one-half block-tab-whole">
                  <div class="column">
                    <p class="drop-cap">
                      ...
                      praesentium impedit maiores incididunt adipisicing veniam velit. Duis ex ad cupidatat tempor
                      Excepteur cillum cupidatat fugiat nostrud cupidatat dolor
...
import PageIndexHeader from "@/components/PageIndexHeader.vue";
import PageIndexContent from "@/components/PageIndexContent.vue";
